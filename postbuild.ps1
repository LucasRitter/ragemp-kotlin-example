...
(Get-Content ".\out\production\$($project)\lib\RageMP-Kotlin-Client.js").replace("module.exports", 'exports') | Set-Content ./client_packages/ragemp.js
...
const ragempAPI = require("ragemp.js");
